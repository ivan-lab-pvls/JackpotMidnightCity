...
class ArticlesData {
  ...
  ArticlesData({required this.image, required this.name, required this.reward, required this.mainImage, required this.mainText,});
}
...
List<ArticlesData> articlesData = [
  ...
  ArticlesData(
    image: '4.png',
    mainImage: '4x.png',
    mainText: 'There are symbols betting options in roulette. The roulette measure is divided into light and dark parts.He determines the winnings. Several identical values in a row give a bonus.',
